...
const Login = () => {
	...
	const { googleLogIn, gitHubLogIn, loginWithEmailPassword, setEmail } =
		use(AuthContext);
	...
	return (
		<div className="pb-10 md:pb-20 lg:pb-32">
			<div className="container">
				<div className="card bg-base-100 mx-auto mt-12 md:mt-36 w-full max-w-lg shrink-0 shadow-2xl">
